...
define("jquery.better-autocomplete", ["jQuery"], function(){});
...
define('text!app/main/views/main.html',[],function () { return '<div id="main_template">\n    <!-- using type="search" enables a cancel icon -->\n    <input type="search" data-class="main-autocomplete" />\n</div>\n';});
...
define("scalejs/extensions", ["scalejs.autocomplete","scalejs.functional","scalejs.linq-linqjs","scalejs.mvvm","scalejs.statechart-scion"], function () { return Array.prototype.slice(arguments); });
/*global require*/
require([
